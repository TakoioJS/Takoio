...
const MAPS: Record<string, FieldMap> = {
  valine: {
    id: 'objectId', url: 'url', nick: 'nick', mail: 'mail',
    link: 'link', comment: 'comment', ua: 'ua', ip: 'ip',
    created: 'createdAt', pid: 'pid', rid: 'rid',
    mailMd5: 'mailMd5', sticker: 'sticker',
  },
  waline: {
    id: 'objectId', url: 'url', nick: 'nick', mail: 'mail',
    link: 'link', comment: 'comment', ua: 'ua', ip: 'ip',
    created: 'insertedAt', pid: 'pid', rid: 'rid',
    state: 'status', mailMd5: 'mailMd5', sticker: 'sticker',
  },
  twikoo: {
    id: '_id', url: 'url', nick: 'nick', mail: 'mail',
    link: 'link', comment: 'comment', ua: 'ua', ip: 'ip',
    created: 'created', pid: 'pid', rid: 'rid',
    isSpam: 'isSpam', mailMd5: 'mailMd5', sticker: 'sticker',
  },
  artalk: {
    id: 'id', url: 'page_key', nick: 'name', mail: 'email',
    link: 'link', comment: 'content', ua: 'ua', ip: 'ip',
    created: 'created_at', pid: 'pid', rid: 'rid',
    isPinned: 'is_pinned', state: 'status',
  },
  disqus: {
    id: 'id', url: 'thread', nick: 'name', mail: 'email',
    comment: 'message', ip: 'ip', created: 'createdAt',
    pid: 'parent', like: 'likes', isSpam: 'isSpam',
  },
}
...
const toComment = (item: any, source: string) => {
  ...
  const stateMap: Record<string, string> = {
    ...
    waiting_review: 'pending', pending: 'pending',
    spam: 'spam', deleted: 'hidden',
  }
